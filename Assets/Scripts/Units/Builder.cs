...
public class Builder : MonoBehaviour
{
    ...
    public GameObject InProgressBuilding
    {
        get { return inProgressBuilding; }
    ...
    private void GhostBuildingFollowsMouse()
    {
        if (showGhost)
        {
            Ray ray = CamController.instance.Cam.ScreenPointToRay(Input.mousePosition);
            RaycastHit hit;
    ...
    public void CreateBuildingSite(Vector3 pos) //Set a building site
    {
        ...
        buildingObj.transform.position = new Vector3(buildingObj.transform.position.x,
            buildingObj.transform.position.y - building.InfoTheGround,
